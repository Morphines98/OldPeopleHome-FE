    ...
    <q-layout view="hHr lpR fFf">
      ...
      <q-drawer v-model="rightDrawerOpen" side="right" behavior="mobile" elevated>
        <q-scroll-area style="height: calc(100% - 150px); margin-top: 150px; border-right: 1px solid #ddd">
          ...
          <RouterLink to="/carer/news" active-class="active-link" style="text-decoration: none;color: black;">
            <q-item clickable v-ripple>
              <q-item-section avatar>
          ...
          <RouterLink to="/carer/activity" active-class="active-link" style="text-decoration: none;color: black;">
            <q-item clickable v-ripple>
              <q-item-section avatar>
          ...
          <RouterLink to="/carer/wall" active-class="active-link" style="text-decoration: none;color: black;">
            <q-item clickable v-ripple>
              <q-item-section avatar>
            ...
            <RouterLink to="/carer/visits" active-class="active-link" style="text-decoration: none;color: black;">
            <q-item clickable v-ripple>
              <q-item-section avatar>
